...
public class DirectionFinder {
    ...
    private static final String API_KEY = "AIzaSyAgub6zr0QjRLJWMq9WFz_YrstJjeM7YRM";
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        return DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" + urlDestination + "&mode=" + travelMode + "&key=" + API_KEY;
    }
